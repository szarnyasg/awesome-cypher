...
* [Samyama Graph](https://github.com/samyama-ai/samyama-graph): a Rust graph-vector database with ~90% openCypher coverage ([documented gaps](https://github.com/samyama-ai/samyama-graph/blob/main/docs/CYPHER_COMPATIBILITY.md)), combining graph traversal with HNSW vector search
